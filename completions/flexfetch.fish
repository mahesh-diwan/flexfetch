...
complete -c flexfetch -n "__fish_flexfetch_needs_command" -f -a "plugin" -d 'Plugin registry (Phase 5.7): search/install/list/update Lua plugins against the hosted registry.toml (checksum + min-version verified)'
...
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -s h -l help -d 'Print help'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -f -a "search" -d 'Search the hosted registry by name/description'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -f -a "install" -d 'Install a plugin (SHA-256 verified, min-version gated)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -f -a "list" -d 'List installed plugins + registry status'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -f -a "update" -d 'Re-install every installed plugin still in the registry'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and not __fish_seen_subcommand_from search install list update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from search" -s h -l help -d 'Print help'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from install" -s h -l help -d 'Print help'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from update" -s h -l help -d 'Print help'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "search" -d 'Search the hosted registry by name/description'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "install" -d 'Install a plugin (SHA-256 verified, min-version gated)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "list" -d 'List installed plugins + registry status'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "update" -d 'Re-install every installed plugin still in the registry'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand plugin; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and not __fish_seen_subcommand_from completions plugin help" -f -a "completions" -d 'Generate shell completions for the given shell'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and not __fish_seen_subcommand_from completions plugin help" -f -a "plugin" -d 'Plugin registry (Phase 5.7): search/install/list/update Lua plugins against the hosted registry.toml (checksum + min-version verified)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and not __fish_seen_subcommand_from completions plugin help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "search" -d 'Search the hosted registry by name/description'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "install" -d 'Install a plugin (SHA-256 verified, min-version gated)'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "list" -d 'List installed plugins + registry status'
complete -c flexfetch -n "__fish_flexfetch_using_subcommand help; and __fish_seen_subcommand_from plugin" -f -a "update" -d 'Re-install every installed plugin still in the registry'
